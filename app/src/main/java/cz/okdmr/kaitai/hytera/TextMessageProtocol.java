...
public class TextMessageProtocol extends KaitaiStruct {
    ...
    public Integer optionFieldLen() {
        return optionFieldLen;
    }
    ...
    public enum AckFlags {
        ...
        public static AckFlags byId(long id) {
            return byId.get(id);
        }
    ...
    public enum OptionFlags {
        ...
        public static OptionFlags byId(long id) {
            return byId.get(id);
        }
