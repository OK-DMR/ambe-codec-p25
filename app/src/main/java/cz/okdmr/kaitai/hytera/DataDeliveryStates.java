...
public class DataDeliveryStates extends KaitaiStruct {
    ...
    public enum StateTypes {
        ...
        public static StateTypes byId(long id) { return byId.get(id); }
    }
    ...
    public StateTypes stateType() { return stateType; }
     ...
     */
    public int protocolOpcode() { return protocolOpcode; }
    public Results result() { return result; }
    public DataDeliveryStates _root() { return _root; }
