...
public class IpSiteConnectProtocol extends KaitaiStruct {
    ...
    public enum PacketTypes {
        ...
        PacketTypes(long id) { this.id = id; }
        ...
        public static PacketTypes byId(long id) { return byId.get(id); }
    }
    ...
    public enum SlotTypes {
        ...
        public static SlotTypes byId(long id) { return byId.get(id); }
    }
     ...
     */
    public byte[] sourcePort() { return sourcePort; }
    public byte[] fixedHeader() { return fixedHeader; }
    public int sequenceNumber() { return sequenceNumber; }
    public byte[] reserved3() { return reserved3; }
    public PacketTypes packetType() { return packetType; }
    public byte[] reserved7a() { return reserved7a; }
    public Timeslots timeslotRaw() { return timeslotRaw; }
    public SlotTypes slotType() { return slotType; }

    /**
     * will be color code repeated, ie. cc=5 means two incoming bytes [0x55, 0x55]
     */
    public int colorCodeRaw() { return colorCodeRaw; }
    public FrameTypes frameType() { return frameType; }
    public byte[] reserved2a() { return reserved2a; }
    public byte[] ipscPayload() { return ipscPayload; }
    public byte[] reserved2b() { return reserved2b; }
    public CallTypes callType() { return callType; }
    public long destinationRadioIdRaw() { return destinationRadioIdRaw; }
    public long sourceRadioIdRaw() { return sourceRadioIdRaw; }
    public int reserved1b() { return reserved1b; }
    public byte[] extraData() { return extraData; }
    public IpSiteConnectProtocol _root() { return _root; }
