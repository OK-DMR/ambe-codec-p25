...
public class Gpsdata extends KaitaiStruct {
     ...
     */
    public byte[] gpsStatus() { return gpsStatus; }

    /**
     * GMT format HHMMSS
     */
    public byte[] gpsTime() { return gpsTime; }

    /**
     * format DDMMYY
     */
    public byte[] gpsDate() { return gpsDate; }

    /**
     * letter N or S
     */
    public byte[] northSouth() { return northSouth; }

    /**
     * DDMM.MMMM D=degree(0-90) M=minute(0-59.9999)
     */
    public byte[] latitude() { return latitude; }

    /**
     * letters E or W
     */
    public byte[] eastWest() { return eastWest; }

    /**
     * DDDMM.MMMM D=degree(0-180) M=minute(0-59.9999)
     */
    public byte[] longitude() { return longitude; }

    /**
     * speed in knots, eg. 0.2
     */
    public byte[] speed() { return speed; }

    /**
     * azimuth(0-359), 0=north, increase is clockwise
     */
    public byte[] direction() { return direction; }
    public Gpsdata _root() { return _root; }
