...
public class RadioRegistrationService extends KaitaiStruct {
    ...
    public enum RrsTypes {
        ...
        public static RrsTypes byId(long id) { return byId.get(id); }
    }
    ...
    public RrsTypes rrsType() { return rrsType; }
    ...
    public Integer result() { return result; }

    /**
     * number of seconds the online registration message shall be resended from terminal
     */
    public Long validTime() { return validTime; }
    public RadioRegistrationService _root() { return _root; }
