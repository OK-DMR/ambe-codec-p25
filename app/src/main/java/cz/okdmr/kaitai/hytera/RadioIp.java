...
public class RadioIp extends KaitaiStruct {
    ...
    public int subnet() { return subnet; }
    public int radioId1() { return radioId1; }
    public int radioId2() { return radioId2; }
    public int radioId3() { return radioId3; }
    public RadioIp _root() { return _root; }
