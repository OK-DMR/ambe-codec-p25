...
public class HyteraSimpleTransportReliabilityProtocol extends KaitaiStruct {
    ...
    public enum OptionCommands {
        ...
        OptionCommands(long id) { this.id = id; }
        ...
        public static OptionCommands byId(long id) { return byId.get(id); }
    }
    ...
    public static class Option extends KaitaiStruct {
        ...
        public boolean expectMoreOptions() { return expectMoreOptions; }
        public OptionCommands command() { return command; }
        public int lenOptionPayload() { return lenOptionPayload; }
        public byte[] optionPayload() { return optionPayload; }
        public HyteraSimpleTransportReliabilityProtocol _root() { return _root; }
        public HyteraSimpleTransportReliabilityProtocol _parent() { return _parent; }
    }
    private byte[] header;
    private int version;
    ...
    public ArrayList<HyteraDmrApplicationProtocol> data() { return data; }
