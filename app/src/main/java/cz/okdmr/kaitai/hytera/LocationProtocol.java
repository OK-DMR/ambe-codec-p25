...
public class LocationProtocol extends KaitaiStruct {
    ...
    public LpSpecificTypes opcodeHeader() {
        return opcodeHeader;
    }
    ...
    public enum CmdTypes {
        ...
        public static CmdTypes byId(long id) {
            return byId.get(id);
        }
    ...
    public enum LpSpecificTypes {
        ...
        LpSpecificTypes(long id) {
            this.id = id;
        }

        public static LpSpecificTypes byId(long id) {
            return byId.get(id);
        }
    ...
    public enum LpGeneralTypes {
        ...
        LpGeneralTypes(long id) {
            this.id = id;
        }

        public static LpGeneralTypes byId(long id) {
            return byId.get(id);
        }
    ...
    public enum TriggerTypes {
        ...
        TriggerTypes(long id) {
            this.id = id;
        }

        public static TriggerTypes byId(long id) {
            return byId.get(id);
        }
    ...
    public enum ResultCodes {
        ...
        public static ResultCodes byId(long id) {
            return byId.get(id);
        }
    ...
    public static class TriggeredReportStopAnswer extends KaitaiStruct {
        ...
        public LocationProtocol _parent() {
            return _parent;
        }
    }
    ...
    public static class ConditionReportRequest extends KaitaiStruct {
        ...
        public Datetimestring startTime() {
            return startTime;
        }

        public Datetimestring stopTime() {
            return stopTime;
        }

        public Intervalstring interval() {
            return interval;
        }

        public Intervalstring maxInterval() {
            return maxInterval;
        }
    ...
    public static class ConditionQuickGpsRequest extends KaitaiStruct {
        ...
        public QuickGpsPayload quickGpsPayload() {
            return quickGpsPayload;
        }
    ...
    public static class QuickGpsPayload extends KaitaiStruct {
        ...
        public int channelUsePercentage() {
            return channelUsePercentage;
        }
        ...
        public LocationProtocol.ConditionQuickGpsRequest _parent() {
            return _parent;
        }
    }
    ...
    public static class TriggeredReport extends KaitaiStruct {
        ...
        public Intervalstring timeRemaining() {
