...
public class HyteraRadioNetworkProtocol extends KaitaiStruct {
    ...
    public byte[] headerIdentifier() { return headerIdentifier; }
    ...
    public int hrnpPacketLength() { return hrnpPacketLength; }
    public int checksum() { return checksum; }
    public HyteraDmrApplicationProtocol data() { return data; }
    public HyteraRadioNetworkProtocol _root() { return _root; }
