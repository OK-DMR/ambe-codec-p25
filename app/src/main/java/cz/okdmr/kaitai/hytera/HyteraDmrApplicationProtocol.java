...
public class HyteraDmrApplicationProtocol extends KaitaiStruct {
    ...
    public enum MessageHeaderTypes {
        ...
        MessageHeaderTypes(long id) { this.id = id; }
        ...
        public static MessageHeaderTypes byId(long id) { return byId.get(id); }
    }
    ...
    public static class UndefinedProtocol extends KaitaiStruct {
        ...
        public HyteraDmrApplicationProtocol _root() { return _root; }
     ...
     */
    public boolean isReliableMessage() { return isReliableMessage; }
    public MessageHeaderTypes messageHeader() { return messageHeader; }
    ...
    public byte[] messageFooter() { return messageFooter; }
    public HyteraDmrApplicationProtocol _root() { return _root; }
    public KaitaiStruct _parent() { return _parent; }
}
