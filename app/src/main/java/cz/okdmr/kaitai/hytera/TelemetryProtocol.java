...
public class TelemetryProtocol extends KaitaiStruct {
    ...
    public ServiceTypes serviceTypeOpcode() {
        return serviceTypeOpcode;
    }

    public int specificServiceOpcode() {
        return specificServiceOpcode;
    }
    ...
    public TelemetryProtocol _root() {
        return _root;
    }
    ...
    public enum ResultTypes {
        ...
        public static ResultTypes byId(long id) {
            return byId.get(id);
        }
    ...
    public enum OperationTypes {
        ...
        OperationTypes(long id) {
            this.id = id;
        }

        public static OperationTypes byId(long id) {
            return byId.get(id);
        }
    ...
    public enum PcFlagTypes {
        ...
        public static PcFlagTypes byId(long id) {
            return byId.get(id);
        }
    ...
    public enum ControlResultTypes {
        ...
        ControlResultTypes(long id) {
            this.id = id;
        }

        public static ControlResultTypes byId(long id) {
            return byId.get(id);
        }
    ...
    public static class StandardStatusReport extends KaitaiStruct {
        ...
        public RadioIp targetIp() {
            return targetIp;
        }

        public PcFlagTypes pcFlag() {
            return pcFlag;
        }
        ...
        public TelemetryProtocol _parent() {
            return _parent;
        }
    }
    ...
    public static class VioExtendedStatus extends KaitaiStruct {
        ...
        public TelemetryProtocol.ExtendedStatusReport _parent() {
            return _parent;
        }
    }
    ...
    public static class RemoteControlAnswer extends KaitaiStruct {
        ...
        public ControlResultTypes result() {
            return result;
        }
    ...
    public static class ExtendedStatusReport extends KaitaiStruct {
        ...
        public VioExtendedStatus resultMessages() {
