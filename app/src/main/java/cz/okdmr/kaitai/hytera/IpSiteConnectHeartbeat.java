...
public class IpSiteConnectHeartbeat extends KaitaiStruct {
    ...
    public static class Keepalive extends KaitaiStruct {
        ...
        public byte[] nullbyte() { return nullbyte; }
        public IpSiteConnectHeartbeat _root() { return _root; }
        public IpSiteConnectHeartbeat _parent() { return _parent; }
    }
    public static class PingPong extends KaitaiStruct {
        ...
        public byte[] heartbeatIdentitier() { return heartbeatIdentitier; }
        public byte[] nullbytes() { return nullbytes; }

        /**
         * raise this byte by one on response
         */
        public int heartbeatSeq() { return heartbeatSeq; }
