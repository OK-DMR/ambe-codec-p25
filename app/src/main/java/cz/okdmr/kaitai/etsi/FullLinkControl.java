...
public class FullLinkControl extends KaitaiStruct {
    ...
    public Flcos fullLinkControlOpcode() {
        return fullLinkControlOpcode;
    }

    /**
     * fid
     */
    public FeatureSetIds featureSetId() {
        return featureSetId;
    }

    public KaitaiStruct specificData() {
        return specificData;
    }
     ...
     */
    public Long cs5Checksum() {
        return cs5Checksum;
    }

    public FullLinkControl _root() {
        return _root;
    }
    ...
    public enum Flcos {
        ...
        public static Flcos byId(long id) {
            return byId.get(id);
        }
    ...
    public enum TalkerDataFormats {
        ...
        TalkerDataFormats(long id) {
            this.id = id;
        }

        public static TalkerDataFormats byId(long id) {
            return byId.get(id);
        }
    ...
    public enum FeatureSetIds {
        ...
        FeatureSetIds(long id) {
            this.id = id;
        }

        public static FeatureSetIds byId(long id) {
            return byId.get(id);
        }
    ...
    public static class GpsInfoLcPdu extends KaitaiStruct {
        ...
        public FullLinkControl _parent() {
            return _parent;
        }
    }
    ...
    public static class TalkerAliasHeader extends KaitaiStruct {
        ...
        public TalkerDataFormats talkerAliasDataFormat() {
            return talkerAliasDataFormat;
        }

        public long talkerAliasDataLength() {
            return talkerAliasDataLength;
        }

        /**
         * 8-bit/16-bit coded => 1st bit reserved (6 or 3 characters), 7-bit coded => all used (7 characters)
         */
        public long talkerAliasData() {
            return talkerAliasData;
        }
