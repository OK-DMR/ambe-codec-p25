...
public class DmrCsbk extends KaitaiStruct {
    ...
    public enum CsbkoTypes {
        ...
        public static CsbkoTypes byId(long id) { return byId.get(id); }
    }
    ...
    public enum CsbkDataOrCsbk {
        ...
        private final long id;
        CsbkDataOrCsbk(long id) { this.id = id; }
        public long id() { return id; }
        ...
        public static CsbkDataOrCsbk byId(long id) { return byId.get(id); }
    }
    ...
    public enum CsbkGroupOrIndividual {
        ...
        private final long id;
        CsbkGroupOrIndividual(long id) { this.id = id; }
        public long id() { return id; }
        ...
        public static CsbkGroupOrIndividual byId(long id) { return byId.get(id); }
    }
    ...
    public enum AnswerResponse {
        ...
        private final long id;
        AnswerResponse(long id) { this.id = id; }
        public long id() { return id; }
        ...
        public static AnswerResponse byId(long id) { return byId.get(id); }
    }
    ...
    public static class NegativeAckResponseData extends KaitaiStruct {
         ...
         * should read 0b1
         */
        public boolean additionalInformationField() { return additionalInformationField; }
        public boolean sourceType() { return sourceType; }
        public long serviceType() { return serviceType; }
        public long reasonCode() { return reasonCode; }
        public long sourceAddress() { return sourceAddress; }
        public long targetAddress() { return targetAddress; }
        public DmrCsbk _root() { return _root; }
        public DmrCsbk _parent() { return _parent; }
    }
    public static class UnitToUnitVoiceRequestData extends KaitaiStruct {
        ...
        private DmrCsbk _root;
        private DmrCsbk _parent;
        public ServiceOptions serviceOptions() { return serviceOptions; }
    ...
    public static class ServiceOptions extends KaitaiStruct {
        ...
        public boolean isEmergencyService() { return isEmergencyService; }
        public boolean privacy() { return privacy; }
        public long reserved() { return reserved; }
        public boolean isBroadcastService() { return isBroadcastService; }
        public boolean isOpenVoiceCallMode() { return isOpenVoiceCallMode; }

        /**
         * 00 => no priority, 11 => priority 3
         */
        public long priorityLevel() { return priorityLevel; }
        public DmrCsbk _root() { return _root; }
    ...
    public static class PreambleData extends KaitaiStruct {
        ...
        private DmrCsbk _root;
        private DmrCsbk _parent;
        public CsbkDataOrCsbk preambleDataOrCsbk() { return preambleDataOrCsbk; }
        public CsbkGroupOrIndividual groupOrIndividual() { return groupOrIndividual; }

        /**
         * should read 0b000000
         */
        public long preambleReserved() { return preambleReserved; }
        public long preambleCsbkBlocksToFollow() { return preambleCsbkBlocksToFollow; }
        public long targetAddress() { return targetAddress; }
        public long sourceAddress() { return sourceAddress; }
        public DmrCsbk _root() { return _root; }
        public DmrCsbk _parent() { return _parent; }
    ...
    public static class ChannelTimingData extends KaitaiStruct {
        ...
        private DmrCsbk _root;
        private DmrCsbk _parent;
        public long syncAge() { return syncAge; }
        public long generation() { return generation; }
        public long leaderIdentifier() { return leaderIdentifier; }
        public boolean newLeader() { return newLeader; }
        public long leaderDynamicIdentifier() { return leaderDynamicIdentifier; }
        public boolean channelTimingOp1() { return channelTimingOp1; }
        public long sourceIdentifier() { return sourceIdentifier; }
        public boolean reserved() { return reserved; }
        public long sourceDynamicIdentifier() { return sourceDynamicIdentifier; }
        public boolean channelTimingOp0() { return channelTimingOp0; }
        public DmrCsbk _root() { return _root; }
        public DmrCsbk _parent() { return _parent; }
    }
    public static class BsOutboundActivationData extends KaitaiStruct {
        ...
        private DmrCsbk _parent;
        public long reserved() { return reserved; }
        public long bsAddress() { return bsAddress; }
        public long sourceAddress() { return sourceAddress; }
        public DmrCsbk _root() { return _root; }
        public DmrCsbk _parent() { return _parent; }
    }
    public static class UnitToUnitVoiceAnswerData extends KaitaiStruct {
        ...
        private DmrCsbk _parent;
        public ServiceOptions serviceOptions() { return serviceOptions; }
        public AnswerResponse answerResponse() { return answerResponse; }
        public long targetAddress() { return targetAddress; }
        public long sourceAddress() { return sourceAddress; }
        public DmrCsbk _root() { return _root; }
        public DmrCsbk _parent() { return _parent; }
     ...
     * CSBKO
     */
    public CsbkoTypes csbkOpcode() { return csbkOpcode; }

    /**
     * FID
     */
    public long featureSetId() { return featureSetId; }
    public KaitaiStruct csbkData() { return csbkData; }
    public DmrCsbk _root() { return _root; }
    public KaitaiStruct _parent() { return _parent; }
}
