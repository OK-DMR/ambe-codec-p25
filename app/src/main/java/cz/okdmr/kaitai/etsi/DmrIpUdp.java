...
public class DmrIpUdp extends KaitaiStruct {
    ...
    public enum SourceIpAddressIds {
        ...
        SourceIpAddressIds(long id) {
            this.id = id;
        }

        public static SourceIpAddressIds byId(long id) {
            return byId.get(id);
        }
    ...
    public enum DestinationIpAddressIds {
        ...
        DestinationIpAddressIds(long id) {
            this.id = id;
        }

        public static DestinationIpAddressIds byId(long id) {
            return byId.get(id);
        }
    ...
    public enum UdpPortIds {
        ...
        public static UdpPortIds byId(long id) {
            return byId.get(id);
        }
    ...
    public static class UdpIpv4CompressedHeader extends KaitaiStruct {
        ...
        public byte[] ipv4Identification() {
         ...
         * SAID
         */
        public SourceIpAddressIds sourceIpAddressId() {
         ...
         * DAID
         */
        public DestinationIpAddressIds destinationIpAddressId() {
            return destinationIpAddressId;
        }

        public boolean headerCompressionOpcodeMsb() {
            return headerCompressionOpcodeMsb;
        }

        /**
         * SPID
         */
        public UdpPortIds udpSourcePortId() {
            return udpSourcePortId;
        }

        public boolean headerCompressionOpcodeLsb() {
            return headerCompressionOpcodeLsb;
        }

        /**
         * DPID
         */
        public UdpPortIds udpDestinationPortId() {
            return udpDestinationPortId;
        }

        public byte[] udpSourcePort() {
            return udpSourcePort;
        }

        public byte[] udpDestinationPort() {
