...
public class AutomaticRegistrationService extends KaitaiStruct {
    ...
    private void _read() {
        ...
        switch ((int) messageHeader().pduType()) {
            case 0: {
    ...
    public AutomaticRegistrationService _root() {
        return _root;
    }
    ...
    public enum RegistrationEvents {
        ...
        RegistrationEvents(long id) {
            this.id = id;
        }

        public static RegistrationEvents byId(long id) {
            return byId.get(id);
        }
    ...
    public enum FailureReasons {
        ...
        FailureReasons(long id) {
            this.id = id;
        }

        public static FailureReasons byId(long id) {
            return byId.get(id);
        }
    ...
    public static class AcknowledgementMessage extends KaitaiStruct {
        ...
        public DeviceRegistrationAcknowledgementHeader deviceRegistrationAcknowledgementHeader() {
            return deviceRegistrationAcknowledgementHeader;
        }

        public DeviceRegistrationAcknowledgementFailureReason deviceRegistrationAcknowledgementFailureReason() {
            return deviceRegistrationAcknowledgementFailureReason;
        }
        ...
        public AutomaticRegistrationService _parent() {
            return _parent;
        }
    }
    ...
    public static class DeviceRegistrationMessageHeader extends KaitaiStruct {
        ...
        public RegistrationEvents event() {
            return event;
        }
        ...
        public AutomaticRegistrationService.DeviceRegistrationMessage _parent() {
            return _parent;
        }
    }
    ...
    public static class MessageHeaderBits extends KaitaiStruct {
         ...
         */
        public boolean acknowledgementBit() {
            return acknowledgementBit;
        }
    ...
    public static class DeviceRegistrationAcknowledgementFailureReason extends KaitaiStruct {
        ...
        public AutomaticRegistrationService.AcknowledgementMessage _parent() {
            return _parent;
        }
    }
    ...
    public static class DeviceRegistrationMessage extends KaitaiStruct {
        ...
        public DeviceRegistrationMessageHeader deviceRegistrationMessageHeader() {
            return deviceRegistrationMessageHeader;
        }

        public int lenDeviceIdentifier() {
            return lenDeviceIdentifier;
        }
        ...
        public int lenUserIdentifier() {
            return lenUserIdentifier;
        }
